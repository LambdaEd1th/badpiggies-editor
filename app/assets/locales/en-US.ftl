...
empty_drop_subtitle = Supports .bytes / .yaml / .yml / .toml / .unity3d and game save files
...
menu_open_save_xml = Open Decrypted Save XML…
menu_extract_unity_levels = Extract Levels from Unity3D…
menu_replace_unity_level = Replace Level in Unity3D…
menu_tools = Tools
