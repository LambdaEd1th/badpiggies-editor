...
empty_drop_subtitle = Admite .bytes / .yaml / .yml / .toml / .unity3d y archivos de guardado del juego
...
menu_open_save_xml = Abrir XML de guardado descifrado…
menu_extract_unity_levels = Extraer niveles de Unity3D…
menu_replace_unity_level = Reemplazar nivel en Unity3D…
