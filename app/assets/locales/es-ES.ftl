...
common_no_file = No hay ningún archivo abierto
settings_title = Configuración
settings_appearance = Modo de apariencia
settings_language = Idioma de la interfaz
settings_logs = Registros
settings_logs_open = Ver registros de la aplicación
logs_clear = Limpiar
...
menu_export_from_unity_assets = Exportar desde archivo assets…
menu_export_level = Exportar nivel
menu_import_to_unity3d = Importar a archivo unity3d…
menu_import_to_unity_assets = Importar a archivo assets…
...
# About window
about_built_with = Creado con Dioxus / Canvas 2D / WebAssembly
...
empty_drop_title = Suelte aquí un archivo de nivel o guardado para cargarlo
empty_drop_subtitle = Admite .bytes / .yaml / .yml / .toml / .unity3d / .assets y archivos de guardado del juego
...
# Interfaz ampliada del espacio de trabajo
common_close = Cerrar
common_more = Más
common_commands = Comandos
common_menus = Menús
menu_new_level = Nuevo nivel
menu_tools = Herramientas
menu_preview_controls = Controles de vista previa
menu_construction_grid = Cuadrícula de construcción
aria_close_menu = Cerrar menú
aria_close_panel = Cerrar panel
aria_resize_object_panel = Cambiar tamaño del panel de objetos
aria_resize_properties_panel = Cambiar tamaño del panel de propiedades
aria_close_object_list = Cerrar lista de objetos
aria_close_properties = Cerrar propiedades
aria_level_canvas = Lienzo del nivel
filter_level_files = Archivos de nivel de Bad Piggies
filter_level_text_files = YAML / TOML
filter_save_files = Archivos de guardado de Bad Piggies
filter_save_xml = XML de guardado descifrado
filter_unity3d_files = Archivos Unity3D
filter_unity_assets_files = Archivos assets de Unity
filter_export = Exportar
status_loading = Cargando { $name }…
status_reading = Leyendo { $name }…
status_unexpected_worker_response = Respuesta inesperada del Worker
status_unsupported_save_name = Nombre de archivo de guardado no compatible
status_unsupported_save_xml = Estructura XML de guardado no compatible
status_no_level_text_assets = No se encontraron TextAssets de nivel en el paquete
status_no_level_text_assets_in_file = No se encontraron TextAssets de nivel en el archivo assets
status_theme_save_error = No se pudo guardar el tema: { $error }
tree_group = Grupo
tree_prefab = Prefabricado
tree_expand_group = Expandir grupo
tree_collapse_group = Contraer grupo
prop_group_children = Grupo con { $count } objetos secundarios
prop_goal_animation = Animación del objetivo
prop_goal_animation_idle = Inactiva
prop_goal_animation_vanishing = Desaparición
prop_fill_vertices = Relleno: { $count } vértices
prop_curve_vertices = Curva: { $count } vértices
prop_alpha = Alfa
prop_fill_opacity = Opacidad del relleno
override_title = Reemplazo del prefabricado
override_visual_tree = Árbol visual
override_raw_text = Texto sin formato
override_add_root = + Añadir campo raíz
override_field_name = Nombre del campo
override_field_value = Valor del campo
override_delete_field = Eliminar campo
override_add_child = + Campo secundario
btn_add_group = Añadir grupo
btn_add_terrain = Añadir terreno
btn_add_prefab = Añadir prefabricado
delete_objects_description = Elimina del nivel los objetos seleccionados y sus elementos secundarios.
level_warning_description = El juego puede rechazar esta estructura de nivel o comportarse de forma inesperada.
level_warning_found = { $name }: se encontraron { $count }
level_warning_review = Revisar advertencias del nivel
level_warning_count = { $count } advertencia(s)
unity_extract_title = Extraer niveles de Unity3D
unity_assets_extract_title = Extraer niveles de assets de Unity
unity_replace_title = Reemplazar nivel de Unity3D
unity_assets_replace_title = Importar nivel en assets de Unity
unity_extract_selected = Extraer selección
unity_replace_export = Reemplazar y exportar
close_unsaved_title = ¿Descartar los cambios sin guardar?
close_unsaved_description = { $name } contiene cambios que no se han exportado.
close_discard = Descartar y cerrar
tool_aria_editor = Herramientas del editor
tool_preview_playback = Reproducción de vista previa
save_entry_count = { $count } entradas
save_export_encrypted = Exportar cifrado
save_view_table = Tabla
save_view_split = Vista dividida
save_view_preview = Vista previa
save_filter_entries = Filtrar entradas
save_xml_parse_error = Error al analizar XML: { $error }
save_preview_contraption_only = La vista previa está disponible para guardados de vehículos.
save_fix_xml = Corrige el XML para restaurar la edición estructurada.
save_contraption_empty = El vehículo no tiene piezas.
text_find_document = Buscar en el documento
text_editor_input = Entrada del editor de texto
text_close_context_menu = Cerrar menú contextual
text_find = Buscar
text_previous = Anterior
text_next = Siguiente
text_case_sensitive = Mayúsculas
text_replace = Reemplazar
text_replace_all = Reemplazar todo
text_close_search = Cerrar búsqueda
