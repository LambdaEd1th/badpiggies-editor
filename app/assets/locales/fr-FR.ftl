...
empty_drop_subtitle = Prend en charge .bytes / .yaml / .yml / .toml / .unity3d et les sauvegardes du jeu
...
menu_open_save_xml = Ouvrir un XML de sauvegarde déchiffré…
menu_extract_unity_levels = Extraire des niveaux de Unity3D…
menu_replace_unity_level = Remplacer un niveau dans Unity3D…
menu_tools = Outils
