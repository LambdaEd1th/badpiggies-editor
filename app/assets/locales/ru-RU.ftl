...
empty_drop_subtitle = Поддерживаются .bytes / .yaml / .yml / .toml / .unity3d и файлы сохранений игры
...
menu_open_save_xml = Открыть расшифрованный XML сохранения…
menu_extract_unity_levels = Извлечь уровни из Unity3D…
menu_replace_unity_level = Заменить уровень в Unity3D…
