...
level_warning_multiple_slingshots = Found { $count } "{ $name }" objects. The original game looks up slingshots through special scene queries and may behave unpredictably with more than one.
...
level_warning_missing_game_camera = No "{ $name }" object was found even though a CameraSystem exists. The shipped CameraSystem prefab normally provides the MainCamera-tagged GameCamera that gameplay code resolves through Camera.main, MainCamera, and GameCamera lookups.
level_warning_missing_hud_camera = No "{ $name }" object was found even though a CameraSystem exists. UI code repeatedly resolves the HUD camera through FindGameObjectWithTag("HUDCamera").
...
tool_terrain_draw_mode_free = Freehand
