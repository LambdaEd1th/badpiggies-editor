...
menu_level_bounds = Editar límites y nodos de la ruta
menu_preview_route = Ruta de vista previa
panel_camera_route = Ruta de cámara
prop_goal_area_view = Vista de GoalArea
prop_initial_view_bounds = Límites de vista inicial
prop_camera_limits = Límites de cámara
prop_build_view_bounds = Límites de vista de construcción
