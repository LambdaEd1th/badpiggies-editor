...
fn load() -> HashMap<String, PartInfo> {
    ...
    let paths = assets::list_pathnames(PREFAB_DIR_ASSET, "_SET.prefab");
    let parse_entry = |asset_path: String| {
        ...
        let default_custom_part_index = default_custom_part_index(filename)?;
