...
pub fn draw_background(
    ...
    if ground_screen.y < rect.bottom() {
        let ground_color = theme
            ...
            .unwrap_or(crate::gpu2d::Color32::from_rgb(0x22, 0x44, 0x44));
        let ground_rect = crate::gpu2d::Rect::from_min_max(
            crate::gpu2d::pos2(rect.left(), ground_screen.y),
            rect.right_bottom(),
        );
...
pub(super) fn background_base_color(theme: Option<&str>) -> crate::gpu2d::Color32 {
    match theme {
        Some("Cave") => assets::ground_color("Cave"),
        Some(theme_name) => assets::sky_top_color(theme_name),
        None => crate::gpu2d::Color32::from_rgb(0x28, 0x2c, 0x34),
    }
}
