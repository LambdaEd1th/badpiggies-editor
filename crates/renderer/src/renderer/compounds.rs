...
pub fn draw_compound(
    ...
    if name.starts_with("FloatingStarBox") || name.starts_with("FloatingPartBox") {
        ...
        ctx.painter.line_segment(
            [rope_bot, rope_top],
            crate::gpu2d::Stroke::new(rope_width, crate::gpu2d::Color32::BLACK),
        );
...
fn draw_prefab_layers(ctx: &DrawCtx<'_>, layers: &[PrefabSpriteLayer], xf: CompoundTransform) {
    ...
    for layer in layers {
        ...
        let max_y = positions
            ...
            .map(|p| p.y)
            .fold(f32::NEG_INFINITY, f32::max);
        let screen_rect = crate::gpu2d::Rect::from_min_max(
            crate::gpu2d::pos2(min_x, min_y),
            crate::gpu2d::pos2(max_x, max_y),
        );
        ...
        let uvs = [
            crate::gpu2d::pos2(uv_min[0], uv_max[1]),
            crate::gpu2d::pos2(uv_min[0], uv_min[1]),
            crate::gpu2d::pos2(uv_max[0], uv_min[1]),
            crate::gpu2d::pos2(uv_max[0], uv_max[1]),
        ];
        let mesh = mesh_quad(tex_id, positions, uvs);
        ctx.painter.add(crate::gpu2d::Shape::mesh(mesh));
    }
}
...
fn mesh_quad(
    tex_id: crate::gpu2d::TextureId,
    positions: [crate::gpu2d::Pos2; 4],
    uvs: [crate::gpu2d::Pos2; 4],
) -> crate::gpu2d::Mesh {
    let mut mesh = crate::gpu2d::Mesh::with_texture(tex_id);
    let white = crate::gpu2d::Color32::WHITE;
...
fn draw_uv_quad_rotated(ctx: &DrawCtx, q: QuadDraw<'_>) {
    ...
    if q.rotation_z.abs() > 0.001 {
        ...
        let rect =
            crate::gpu2d::Rect::from_center_size(center, crate::gpu2d::vec2(hw * 2.0, hh * 2.0));
        let uv_rect = crate::gpu2d::Rect::from_min_max(
            crate::gpu2d::pos2(u0, v0),
            crate::gpu2d::pos2(u1, v1),
        );
        mesh.add_rect_with_uv(rect, uv_rect, crate::gpu2d::Color32::WHITE);
    }
    ctx.painter.add(crate::gpu2d::Shape::mesh(mesh));
}
