...
impl LevelRenderer {
    ...
    fn point_in_terrain(&self, index: ObjectIndex, pos: Vec2) -> bool {
        ...
        for tri in indices.chunks_exact(3) {
            ...
            let a = crate::gpu2d::pos2(verts[i0].pos.x + ox, verts[i0].pos.y + oy);
            let b = crate::gpu2d::pos2(verts[i1].pos.x + ox, verts[i1].pos.y + oy);
            let c = crate::gpu2d::pos2(verts[i2].pos.x + ox, verts[i2].pos.y + oy);
            if point_in_triangle(crate::gpu2d::pos2(pos.x, pos.y), a, b, c) {
                return true;
            }
        }
        false
