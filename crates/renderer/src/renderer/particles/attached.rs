...
fn particle_color_to_egui(color: unity_particles::ParticleColor) -> crate::gpu2d::Color32 {
...
fn attached_effect_render_z(emitter_world_z: f32, system: &UnityParticleSystemDef) -> f32 {
    emitter_world_z + system.local_position.z
}
...
fn attached_effect_spawn_particle(
    ...
    particles.push(AttachedEffectParticle {
        ...
        render_z: attached_effect_render_z(emitter.world_z, system),
        vx: world_velocity.x,
        vy: world_velocity.y,
        fx: world_force.x,
        fy: world_force.y,
...
pub(crate) fn draw_attached_effect_particles(
    particles: &[AttachedEffectParticle],
    source_emitter_and_system: Option<(usize, usize)>,
    camera: &Camera,
    painter: &crate::gpu2d::Painter,
    canvas_center: crate::gpu2d::Vec2,
    rect: crate::gpu2d::Rect,
    tex_id: Option<crate::gpu2d::TextureId>,
) {
    for particle in particles {
        ...
        let rot_pt = |dx: f32, dy: f32| -> crate::gpu2d::Pos2 {
            crate::gpu2d::pos2(
        ...
        if let Some(tex_id) = tex_id {
            ...
            let mut mesh = crate::gpu2d::Mesh::with_texture(tex_id);
...
mod tests {
    ...
    #[test]
    fn attached_effect_spawn_uses_system_local_z_for_render_order() {
        let emitter = AttachedEffectEmitter {
            world_x: 0.0,
            world_y: 0.0,
            world_z: 3.5,
            rot: 0.0,
            kind: AttachedEffectKind::TurboCharger,
            system_time: vec![0.0; attached_effect_systems(AttachedEffectKind::TurboCharger).len()],
            spawn_accum: vec![0.0; attached_effect_systems(AttachedEffectKind::TurboCharger).len()],
        };
        let mut particles = Vec::new();

        attached_effect_spawn_particle(&emitter, 0, 0, &mut particles, 0);
