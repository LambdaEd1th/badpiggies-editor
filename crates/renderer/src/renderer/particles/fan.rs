...
pub(crate) fn draw_fan_particles(
    ...
    for p in particles {
        ...
        if let Some(tex_id) = tex_id {
            ...
            let color = crate::gpu2d::Color32::from_rgba_unmultiplied(255, 255, 255, alpha);
            let cos_r = p.rot.cos();
            let sin_r = p.rot.sin();
            ...
            let puff_color = crate::gpu2d::Color32::from_rgba_unmultiplied(220, 230, 245, alpha);
            let puff_rect = crate::gpu2d::Rect::from_center_size(
                center,
                crate::gpu2d::vec2(hw * 2.0, hh * 2.0),
            );
