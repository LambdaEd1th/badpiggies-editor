...
pub(super) fn has_glow(name: &str) -> bool {
...
pub fn draw_glow(
    ...
    canvas_rect: crate::gpu2d::Rect,
    time: f64,
    glow_tex: crate::gpu2d::TextureId,
) {
    ...
    let mut mesh = crate::gpu2d::Mesh::with_texture(glow_tex);
    let tl = rot(-glow_hw, -glow_hh);
    let tr = rot(glow_hw, -glow_hh);
    let br = rot(glow_hw, glow_hh);
    let bl = rot(-glow_hw, glow_hh);
    let white =
        crate::gpu2d::Color32::from_rgba_unmultiplied(255, 255, 255, (255.0 * glow.alpha) as u8);
