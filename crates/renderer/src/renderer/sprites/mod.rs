...
//! when atlas textures aren't loaded. Supports textured rendering through the GPU 2D layer.
...
pub(super) fn has_time_animation(sprite: &SpriteDrawData) -> bool {
    sprite.name_lower.starts_with("goalarea")
        || (sprite.name.starts_with("Bird_") && !sprite.name.starts_with("BirdCompass"))
        || glow::has_glow(&sprite.name)
}
...
fn sprite_shader_tint(color: crate::gpu2d::Color32) -> [f32; 4] {
    [
...
struct WorldEffectTextures {
    wind_particle: Option<crate::gpu2d::TextureId>,
    zzz_particle: Option<crate::gpu2d::TextureId>,
    fan_particle: Option<crate::gpu2d::TextureId>,
    attached_effect: Option<crate::gpu2d::TextureId>,
}
        ...
        for si in 0..self.sprite_data.len() {
            ...
            if skip_root && is_sel {
                ...
                let sel_rect = crate::gpu2d::Rect::from_center_size(
                    center,
                    crate::gpu2d::vec2(hw.max(4.0) * 2.0, hh.max(4.0) * 2.0),
                );
                painter.rect_stroke(
                    sel_rect.expand(2.0),
                    2.0,
...
mod tests {
    ...
    fn sprite_shader_tint_uses_sprite_color_channels() {
        assert_close(
            sprite_shader_tint(crate::gpu2d::Color32::from_rgba_unmultiplied(
                190, 190, 255, 255,
            )),
