...
pub(crate) struct DrawCtx<'a> {
    pub painter: &'a crate::gpu2d::Painter,
    pub camera: &'a Camera,
    pub canvas_center: crate::gpu2d::Vec2,
    pub canvas_rect: crate::gpu2d::Rect,
...
/// Context-menu state emitted by the raw canvas for the Dioxus shell to show.
pub struct CanvasContextMenuRequest {
    pub screen_pos: crate::gpu2d::Pos2,
    pub world_pos: Option<Vec2>,
    pub indices: Vec<ObjectIndex>,
    pub node: Option<(ObjectIndex, usize, bool)>,
    pub can_flip: bool,
}
