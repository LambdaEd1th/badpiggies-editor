...
pub(super) use crate::domain::prefab_override::{OverrideNode, parse_override_text};
use crate::i18n::locale::I18n;

pub(super) fn serialize_override_tree(nodes: &[OverrideNode], _depth: usize) -> String {
    crate::domain::prefab_override::serialize_override_tree(nodes)
}
